...
### v1.0.260327 (APK版本)
- ✨ **版本更新**：更新到v1.0.260327版本
- ✨ **新增ADB模式**：添加了ADB模式支持
- ✨ **开机自启动Shizuku**：支持开机自启动Shizuku功能
- ✨ **BYD后台启动项管理**：添加了BYD后台启动项管理功能
- ✨ **自定义命令功能**：新增自定义命令设置，支持开机延迟20秒后执行自定义shell命令
- ✨ **进程重复检测**：优化了自定义命令的进程检测逻辑，防止重复启动
...
- **开发者**： [usertest001/](https://github.com/usertest001/)
