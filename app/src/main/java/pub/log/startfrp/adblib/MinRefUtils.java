package pub.log.startfrp.adblib;
...
//    }
    ...
    private static boolean exemptAll() {
        if (!isInit) {
            isInit = setHiddenApiExemptions(new String[]{"L"
//                , "Landroid/" "Lcom/", "Ljava/", "Ldalvik/", "Llibcore/", "Lsun/", "Lhuawei/"
    ...
    public static Object call(String className, String methodName) {
        return call(findClass(className), methodName, null, null, null);
    }
    ...
    public static Object call(String className, String methodName, Object receiver) {
        return call(findClass(className), methodName, receiver, null, null);
    }
    ...
    public static Object call(String className, String methodName, Object receiver, Class[] types, Object[] params) {
    ...
    public static Class findClass(String className, ClassLoader loader) {
        ...
        if (loader == null) {
            ...
            try {
                return new MinRefUtils().getClass().getClassLoader().loadClass(className);
            } catch (Throwable e) {
                e(e);
            }
        } else {
